...
-- Câu 2: Câu 2: Tạo một Regular Index tên là idxFullName cho cột FullName của bảng Student.
...
CREATE VIEW ViewITEnrollmentDB AS (
	SELECT e.StudentID, e.CourseID, e.Score, d.DeptName
	FROM Enrollment e
	JOIN Student s 
    ON e.StudentID = s.StudentID
	JOIN Department d ON s.DeptID = d.DeptID
	WHERE d.DeptName = 'Information Technology' AND e.CourseID = 'CS101'
)
WITH CHECK OPTION;
